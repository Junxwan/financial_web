...
class CreateReportsTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('reports', function (Blueprint $table) {
            ...
            $table->integer('revenue_m_1')->default(0)->comment('1月營收');
            $table->integer('revenue_m_2')->default(0)->comment('2月營收');
            $table->integer('revenue_m_3')->default(0)->comment('3月營收');
            $table->integer('revenue_m_4')->default(0)->comment('4月營收');
            $table->integer('revenue_m_5')->default(0)->comment('5月營收');
            $table->integer('revenue_m_6')->default(0)->comment('6月營收');
            $table->integer('revenue_m_7')->default(0)->comment('7月營收');
            $table->integer('revenue_m_8')->default(0)->comment('8月營收');
            $table->integer('revenue_m_9')->default(0)->comment('9月營收');
            $table->integer('revenue_m_10')->default(0)->comment('10月營收');
            $table->integer('revenue_m_11')->default(0)->comment('11月營收');
            $table->integer('revenue_m_12')->default(0)->comment('12月營收');
